...
$(OBJ)/compute_potential_N_uptake_hybrid.o \
...
rhessys: $(OBJECTS)
	$(CC) $(OBJECTS) $(CFLAGS) -I include -lm -v -o $(PGM) 
...
$(OBJ)/output_basin.o: output/output_basin.c
	$(CC) -c $(CFLAGS) -I include output/output_basin.c -o $(OBJ)/output_basin.o
...
$(OBJ)/compute_potential_N_uptake_hybrid.o: cn/compute_potential_N_uptake_hybrid.c 
	$(CC) -c $(CFLAGS) -I include cn/compute_potential_N_uptake_hybrid.c -o $(OBJ)/compute_potential_N_uptake_hybrid.o
